...
void GameScene::checkMsg()
{
	...
	GameManager::getInstance()->getServer()->SendMsg(send1, 1);
	GameManager::getInstance()->getServer()->SendMsg(send2, 1);
	recv1 = GameManager::getInstance()->getServer()->Listening();
	recv2 = GameManager::getInstance()->getServer()->Listening();
}